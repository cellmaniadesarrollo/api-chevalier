...
routes.get("/api/salescashierdailyreport", logged, hasRole('CASHIER', 'ADMIN'), SalesController.getCashierDailyReport);
routes.get("/api/mycutsreport", logged, hasRole('HAIRDRESSER'), SalesController.getMyCutsReport);
